...
/**
 *	KeyComboBitField_t - Struct which represents a combination of pressed keys
 */
...
/**
 *	KeyComboBitFieldHash_t - Used to hash a KeyComboBitField_t
 */
...
/**
 *	KeyComboBitFieldHash_t - Callback used when a combination of keys matches a KeyComboBitField_t
 */
struct InputCallbackInfo_t {
	...
	kbIInputCallback *										m_CallbackObject;
	int														m_CallbackParam;
...
public:
	...
	void										MapKeysToCallback( const std::string & stringCombo, kbIInputCallback *const pCB, int CallbackParam, const std::string & helpDescription = "" );
	void										UnmapCallback( kbIInputCallback *const pCB );
